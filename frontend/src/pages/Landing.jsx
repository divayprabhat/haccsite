...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen overflow-hidden liquid-bg">
      ...
      >
        ...
        >
          <motion.div
            ...
            className="glass-liquid rounded-[24px] sm:rounded-[36px] px-4 sm:px-6 md:px-10 py-8 sm:py-12 md:py-14 w-full flex flex-col items-center text-center"
          >
            <motion.h1
